export default {
  ...
  exit: 'Effettua il logout',
  deleteaccountanddata: 'Elimina account e dati',
  requestDataExport: 'Richiedi esportazione dati',
  requestNewExport: 'Richiedi nuova esportazione',
  exportProcessing: 'Elaborazione richiesta...',
  downloadData: 'Scarica i tuoi dati',
  exportSuccess: 'File scaricato con successo!',
  ...
  favourite: 'Preferiti',
  notificationemail: 'Notifiche email',
  notificationemailsubtitle: 'Ricevute all’email',
