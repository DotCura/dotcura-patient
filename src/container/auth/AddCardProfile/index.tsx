...
import AddCardProfileComponent from '../../../components/auth/AddCardProfile';
import AppHeader from '../../../global/Header';

const AddCardProfileContainer = ({ navigation }: any) => {
...
export default AddCardProfileContainer;
